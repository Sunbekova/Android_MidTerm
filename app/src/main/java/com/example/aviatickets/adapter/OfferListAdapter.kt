...
class OfferListAdapter : RecyclerView.Adapter<OfferListAdapter.ViewHolder>() {
    ...
    fun sortOffersByDuration() {
        items.sortedBy { it.flight.duration }
        notifyDataSetChanged()
    }
    ...
    inner class ViewHolder(
        ...
        fun bind(offer: Offer) {
            ...
            with(binding) {
                ...
                Glide.with(context)
                    .load(getAirlineImageUrl(flight.airline.code))
                    .into(airlineImage)
            }
        }
...
private fun getAirlineImageUrl(airlineCode: String): String {
      return when (airlineCode) {
        "KC" -> "https://example.com/airline_kc_logo.png"
        "DV" -> "https://example.com/airline_dv_logo.png"
        else -> "https://example.com/default_airline_logo.png"
    }
}